#ifndef __ABOO_ENDIAN_H__
#define __ABOO_ENDIAN_H__

#define ABOO_LITTLE_ENDIAN 1
#define	ABOO_BIG_ENDIAN 2
...
#define ABOO_BYTE_ORDER ABOO_BIG_ENDIAN
#else
#define ABOO_BYTE_ORDER ABOO_LITTLE_ENDIAN
#endif

#if ABOO_BYTE_ORDER == ABOO_BIG_ENDIAN
template<class T>
